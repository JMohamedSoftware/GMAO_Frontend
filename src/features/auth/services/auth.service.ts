...
// ---------- Mock Auth (Développement local) ----------

/**
 * Simule une authentification locale (sans backend).
 * À utiliser uniquement en développement !
 */
export function mockLogin(email: string): AuthUser | null {
  const mockUsers: Record<string, AuthUser> = {
    'admin@gmao-saas.com': {
      id: 'u-super-1',
      email: 'admin@gmao-saas.com',
    ...
    'admin@midi.com': {
      id: 'u-admin-1',
      email: 'admin@midi.com',
      name: 'Admin Midi',
      role: 'CompanyAdmin',
      tenantId: 'tenant-midi',
      tenantName: 'Midi Conserves',
      isActive: true,
      createdAt: new Date().toISOString(),
    },
    'resp@midi.com': {
